...
for motor, pins in motor_select_pins.items():
    ...
    # Assuming you use Arduino's pinMode() to set the pins as OUTPUT
...
def motor2(direction, speed):
    """Control Motor 2"""
    gpio.output(motor_select_pins['M2']['In3'], direction == 'forward')
    gpio.output(motor_select_pins['M2']['In4'], direction == 'backward')
    pwm.ChangeDutyCycle(speed)
...
def motor4(direction, speed):
    """Control Motor 4"""
    gpio.output(motor_select_pins['M4']['In3'], direction == 'forward')
    gpio.output(motor_select_pins['M4']['In4'], direction == 'backward')
    pwm.ChangeDutyCycle(speed)
